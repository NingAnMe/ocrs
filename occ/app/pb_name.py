...
@nameClassManager.plugin
class FY3_MERSI_OCC_L2(satNameBase):
    '''
    FY3B_MERSI_ORBT_L2_OCC_MLT_NUL_20130101_0000_1000M.HDF
    '''

    def __init__(self):
        pat = u'\w{4}_MERSI_ORBT_L2_OCC_MLT_NUL_(\d{8})_(\d{4})_\w{5}.HDF$'
        totalSec = 5 * 60
        satNameBase.__init__(self, pat, totalSec)
...
@nameClassManager.plugin
class AQUA_MODDIS_OCC_L2(satNameBase):
    '''
    A2013001002000.L2_LAC_OC.nc
    '''

    def __init__(self):
        pat = u'A(\d{4})(\d{3})(\d{6}).L2_LAC_OC.nc$'
        totalSec = 5 * 60
        satNameBase.__init__(self, pat, totalSec)
